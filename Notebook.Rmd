...
[Descarga esta base de datos de 8 x 2 en formato CSV]()
...
Una primera comparación sencilla pero ilustrativa tiene que ver con la extensión de los programas de gobierno en páginas y palabras. Se espera que un documento que detalla el gobierno de todo un país sea lo suficientemente complejo y por tanto con cierta extensión.
...
```{r}
# Hacemos un conteno de la frecuencia de palabras más usadas por cada partido en sus programas
...
[Descarga esta base de datos 30.910 x 7 en formato CSV]()
...
[Descarga esta base de datos de 80 x 7 en formato CSV]()
...
Este gráfico nos da la perspectiva más particular de los conceptos usados en los programas de gobierno. Ahora aparecen algunos conceptos diferenciadores.
